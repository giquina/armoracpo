...
-- ============================================================================
--
-- ⚠️  WARNING: DO NOT RUN THIS SCRIPT IN PRODUCTION!
--
-- This script inserts comprehensive test data for development and testing
-- purposes only. It creates realistic sample data for the Armora CPO platform
-- including protection officers, assignments, payments, incidents, and messages.
--
-- Usage: Run this script in your local/development Supabase instance only.
-- ============================================================================

-- ============================================================================
-- 1. TEST PROTECTION OFFICERS (CPOs)
-- ============================================================================
-- Creating 5 CPOs with varied profiles, specializations, and availability
...
-- ============================================================================
-- 2. TEST PRINCIPALS (CLIENTS)
-- ============================================================================
-- Creating principal records for assignment data

-- Note: These would typically come from the client app, but we need them for test assignments
-- These are simplified entries focusing on what CPO app needs

-- ============================================================================
-- 3. PROTECTION ASSIGNMENTS
-- ============================================================================
-- Creating a mix of pending, active, completed, and cancelled assignments
...
-- 4. PAYMENT RECORDS
-- ============================================================================
-- Creating payment records for completed assignments
...
-- Payment 4: Processing - Transport Security (James Mitchell) - Currently Active
(
...
-- 5. INCIDENT REPORTS
-- ============================================================================
-- Creating sample security incident reports
...
-- ============================================================================
-- 6. ASSIGNMENT MESSAGES
-- ============================================================================
-- Creating sample messages between principals and CPOs
...
-- Messages for Assignment 2 (Amara with Ms. Ashford - Shopping Trip)
(
...
-- Messages for Assignment 3 (James with Mr. Chen - Active Transport)
(
...
-- ============================================================================
-- 7. NOTIFICATIONS (if notifications table exists)
-- ============================================================================
-- Note: Adjust table name and structure based on your actual notifications schema
-- This is a generic example - modify as needed
...
--
-- All IDs use test UUID format: xxx-00000000-0000-0000-000X-XXXXXXXXXXXX
-- All email addresses use @armoracpo.test domain
-- All phone numbers use test range +4477009000XX
--
-- This data provides comprehensive coverage for testing:
